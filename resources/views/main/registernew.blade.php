    ...
    <div class="container-login100">
        <div class="wrap-login101 ">
            <form class="login100-form validate-form" method="POST" action="{{ route('register') }}" id="LoginForm">
                <button type="" class="button-close"><a href="{{url('/admin/dashboard')}}"><i class="bi bi-x-lg"></i></a></button>
                @csrf
                <!--=====TIÊU ĐỀ======-->
                ...
                <div class="text-right">
                    <a href="{{url('/admin/dashboard')}}"><input type="button" class="login-form__submit button button--main button--full bg-gradient-dark" value="BACK!" /></a>
                </div>
                {!! Form::hidden('type', 0) !!}
            </form>
        </div>
